...
import { ContentTaxonomy, PlannerAnalytics, TaxonomyKind, getPostMetric } from '../../types/posts';
...
export default function PlannerAnalyticsView({ taxonomies }: Props) {
  ...
  const cards = summary ? [
    ...
    { label: 'Impresiones', value: number.format(summary.views), detail: `${number.format(summary.average_views)} de media`, icon: Eye, color: 'text-blue-700 bg-blue-50' },
